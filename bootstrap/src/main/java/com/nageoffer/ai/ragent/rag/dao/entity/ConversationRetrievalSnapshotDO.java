...
@AllArgsConstructor
@Builder
@TableName(value = "t_conversation_retrieval_snapshot", autoResultMap = true)
public class ConversationRetrievalSnapshotDO {
    ...
    @TableField(typeHandler = JsonbTypeHandler.class)
    private String intentIdsJson;

    @TableField(typeHandler = JsonbTypeHandler.class)
    private String resultRefsJson;

    @TableField(typeHandler = JsonbTypeHandler.class)
    private String reusedSnapshotIdsJson;
