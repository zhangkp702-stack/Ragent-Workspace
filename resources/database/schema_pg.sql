...
CREATE INDEX idx_task_turn_task_time ON t_conversation_task_turn (task_id, create_time);
...
CREATE INDEX idx_retrieval_snapshot_task_time ON t_conversation_retrieval_snapshot (task_id, create_time);
